...
import type { Star, StarAnimationService } from '../../services/star-animation.service';
...
@Component({
  ...
  styleUrls: ['./form-page.component.scss', './form-page.component.adaptives.scss'],
})
export class FormPageComponent implements OnInit, OnDestroy {
  ...
  get isEmailValid() {
    return (
      this.emailControl.valid && this.emailControl.value && this.emailControl.value.trim() !== ''
    );
  }
